...
with st.sidebar:
      ...
      # Sidebar filter
      st.sidebar.image("https://upload.wikimedia.org/wikipedia/commons/7/77/Streamlit-logo-primary-colormark-darktext.png")
      st.sidebar.write('Copyright (C) © 2025 by Hanifa ')
...
daily_orders_df=number_order_per_month(filtered_df)
most_and_least_products_df=create_by_product_df(filtered_df)
rating_service,max_score,df_rating_service=rating_cust_df(filtered_df)
customer_spend_df=customer_spend_df(filtered_df)

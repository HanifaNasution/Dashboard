...
st.write(
    """
    Visualisasi tersebut memberikan informasi bahwa pada tahun 2018:
    Pembelian tertinggi berada pada Bulan November
    Pembelian terendah berada pada Bulan September
    """)
...
st.write(
    """
    Visualisasi tersebut memberikan informasi bahwa pada tahun 2018:
    Total pembelian yang tercatat sebesar 10901214.39
    Rata-rata pembelian yang tercatat sebesar 908434.53
    """)
...
st.write(
    """
    Visualisasi tersebut memberikan informasi bahwa pada tahun 2018:
    Produk dengan penjualan tertinggi adalah produk dengan kategori Bed Bath Table
    Produk dengan penjualan terendah adalah produk dengan kategori Security and Services
    """)
...
st.write(
    """
    Visualisasi tersebut memberikan informasi bahwa pada tahun 2018:
    Mayoritas pengguna memberikan rating 5
    Rata-rata rating yang diberikan pengguna sebesar 4.02
    Rating 1 cukup banyak diberikan pengguna sehingga perlu dianalisa lebih lanjut
    """)
...
with tab1:
    ...
    st.write(
        """
        Pengguna yang melakukan transaksi di E-Commerce paling terbaru tercatat 3 hari yang lalu
        """
    )
...
with tab2:
    ...
    st.write(
        """
        Pengguna yang melakukan transaksi di E-Commerce paling banyak tercatat sebanyak 62 kali
        """
    )
...
with tab3:
    ...
    st.write(
        """
        Pengguna yang melakukan transaksi di E-Commerce dengan nominal paling tinggi tercatat sebesar $13980
        """
    )
